...
particles = [Particle(pygame.Vector3(int(randint(0,WIDTH)),int(randint(0,HEIGHT)), int(randint(0,100))), 2, (randint(0,10),randint(0,10),randint(0,10))) for i in range(100)]
